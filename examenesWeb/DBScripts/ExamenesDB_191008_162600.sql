...
alter table "public"."sequenceflow"   add constraint fk_sequenceflow_activitytype foreign key ("activitytype_oid") references "public"."activitytype" ("oid");
...
alter table "public"."sequenceflow"   add constraint fk_sequenceflow_activitytype_2 foreign key ("activitytype_oid_2") references "public"."activitytype" ("oid");
