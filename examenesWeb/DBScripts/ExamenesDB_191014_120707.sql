...
alter table "public"."previousactivityinstance_nexta"   add constraint fk_previousactivityinstance_2 foreign key ("activityinstance_oid_2") references "public"."activityinstance" ("oid");
alter table "public"."previousactivityinstance_nexta"   add constraint fk_previousactivityinstance_ne foreign key ("activityinstance_oid") references "public"."activityinstance" ("oid");
...
-- materias_bancoPreguntas [rel10]
alter table "public"."bancopreguntas"  add column  "materias_oid"  int4;
alter table "public"."bancopreguntas"   add constraint fk_bancopreguntas_materias foreign key ("materias_oid") references "public"."materias" ("oid");


-- bancoPreguntas_bancoRespuestas [rel11]
alter table "public"."bancorespuestas"  add column  "bancopreguntas_oid"  int4;
alter table "public"."bancorespuestas"   add constraint fk_bancorespuestas_bancopregun foreign key ("bancopreguntas_oid") references "public"."bancopreguntas" ("oid");


-- contexto_materias [rel9]
alter table "public"."materias"  add column  "contexto_oid"  int4;
alter table "public"."materias"   add constraint fk_materias_contexto foreign key ("contexto_oid") references "public"."contexto" ("oid");
