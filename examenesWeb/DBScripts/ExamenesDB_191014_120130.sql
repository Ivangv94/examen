...
alter table "public"."attachment_processinstance"   add constraint fk_attachment_processinstanc_2 foreign key ("attachment_oid") references "public"."attachment" ("oid");
alter table "public"."attachment_processinstance"   add constraint fk_attachment_processinstance foreign key ("processinstance_oid") references "public"."processinstance" ("oid");
...
-- materias_contexto [rel6]
alter table "public"."materias"  add column  "oid"  int4;
alter table "public"."materias"   add constraint fk_materias_contexto foreign key ("oid") references "public"."contexto" ("oid");


-- bancoPreguntas_materias [rel7]
alter table "public"."bancopreguntas"  add column  "oid"  int4;
alter table "public"."bancopreguntas"   add constraint fk_bancopreguntas_materias foreign key ("oid") references "public"."materias" ("oid");


-- bancoRespuestas_bancoPreguntas [rel8]
alter table "public"."bancorespuestas"  add column  "oid"  int4;
alter table "public"."bancorespuestas"   add constraint fk_bancorespuestas_bancopregun foreign key ("oid") references "public"."bancopreguntas" ("oid");
